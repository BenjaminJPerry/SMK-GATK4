...
# ENTRY POINTS
        ...
        # "results/04_merged/merged.MFF.chrom.norm.DPFilt.QUAL60.haplotypeCaller.vcf.gz",


rule all:
    input:
        "results/05_ensemble/merged.MFF.chrom.norm.DPFilt.QUAL60.bcftools.eva.intersect.vcf.gz",
        "results/05_ensemble/merged.MFF.chrom.norm.DPFilt.QUAL60.freebayes.eva.intersect.vcf.gz",
        "results/05_ensemble/merged.MFF.chrom.norm.DPFilt.QUAL60.haplotypeCaller.eva.intersect.vcf.gz",
...
rule isec_bcftools_eva:
    priority:100
    input:
        filtered = "results/04_merged/merged.MFF.chrom.norm.DPFilt.QUAL60.bcftools.vcf.gz",
    ...
    output:
        eva_filtered = "results/04_merged/merged.MFF.chrom.norm.DPFilt.QUAL60.bcftools.eva.vcf.gz",
        csi = "results/04_merged/merged.MFF.chrom.norm.DPFilt.QUAL60.bcftools.eva.vcf.gz.csi",
    threads:8
    conda:
        "bcftools-1.19"
    resources:
...
rule isec_freebayes_eva:
    priority:100
    input:
        filtered = "results/04_merged/merged.MFF.chrom.norm.DPFilt.QUAL60.freebayes.vcf.gz",
        csi = "results/04_merged/merged.MFF.chrom.norm.DPFilt.QUAL60.freebayes.vcf.gz.csi",
        eva = "resources/eva/9940_GCA_016772045.1_current_ids.sed.vcf.gz",
        eva_csi = "resources/eva/9940_GCA_016772045.1_current_ids.sed.vcf.gz.csi"
    output:
        eva_filtered = "results/04_merged/merged.MFF.chrom.norm.DPFilt.QUAL60.freebayes.eva.vcf.gz",
        csi = "results/04_merged/merged.MFF.chrom.norm.DPFilt.QUAL60.freebayes.eva.vcf.gz.csi",
    threads:8
    conda:
        "bcftools-1.19"
    resources:
...
rule isec_haplotypeCaller_eva:
    priority:100
    input:
        filtered = "results/04_merged/merged.MFF.chrom.norm.DPFilt.QUAL60.haplotypeCaller.vcf.gz",
        csi = "results/04_merged/merged.MFF.chrom.norm.DPFilt.QUAL60.haplotypeCaller.vcf.gz.csi",
        eva = "resources/eva/9940_GCA_016772045.1_current_ids.sed.vcf.gz",
        eva_csi = "resources/eva/9940_GCA_016772045.1_current_ids.sed.vcf.gz.csi"
    output:
        eva_filtered = "results/04_merged/merged.MFF.chrom.norm.DPFilt.QUAL60.haplotypeCaller.eva.vcf.gz",
        csi = "results/04_merged/merged.MFF.chrom.norm.DPFilt.QUAL60.haplotypeCaller.eva.vcf.gz.csi",
    threads:8
    conda:
        "bcftools-1.19"
    resources:
...
rule ensemble_intersection:
    priority: 100
    input:
        bcftools = "results/04_merged/merged.MFF.chrom.norm.DPFilt.QUAL60.bcftools.eva.vcf.gz",
        bcftools_csi = "results/04_merged/merged.MFF.chrom.norm.DPFilt.QUAL60.bcftools.eva.vcf.gz.csi",
        freebayes = "results/04_merged/merged.MFF.chrom.norm.DPFilt.QUAL60.freebayes.eva.vcf.gz",
        freebayes_csi = "results/04_merged/merged.MFF.chrom.norm.DPFilt.QUAL60.freebayes.eva.vcf.gz.csi",
        haplotypecaller = "results/04_merged/merged.MFF.chrom.norm.DPFilt.QUAL60.haplotypeCaller.eva.vcf.gz",
        haplotypecaller_csi = "results/04_merged/merged.MFF.chrom.norm.DPFilt.QUAL60.haplotypeCaller.eva.vcf.gz.csi",
    output:
        bcftools_common = "results/05_ensemble/merged.MFF.chrom.norm.DPFilt.QUAL60.bcftools.eva.intersect.vcf.gz",
        freebayes_common = "results/05_ensemble/merged.MFF.chrom.norm.DPFilt.QUAL60.freebayes.eva.intersect.vcf.gz",
        haplotypecaller_common = "results/05_ensemble/merged.MFF.chrom.norm.DPFilt.QUAL60.haplotypeCaller.eva.intersect.vcf.gz",
    threads:6
    conda:
        "bcftools-1.19"
    resources:
