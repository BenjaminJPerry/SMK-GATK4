...
rule ensemble_intersection:
    ...
    output:
        ...
        bcftools_common_csi = "results/04_filtered/merged.MFF.chrom.norm.monomorphic.DPFilt.eva.freebayes.intersection.vcf.gz.csi",
        ...
        bcftools_common_csi = "results/04_filtered/merged.MFF.chrom.norm.monomorphic.DPFilt.eva.haplotypeCaller.intersection.vcf.gz.csi",
    threads:6
    conda:
        "bcftools-1.19"
    resources:
