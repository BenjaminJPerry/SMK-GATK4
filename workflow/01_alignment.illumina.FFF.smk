...
SAMPLES, = glob_wildcards("fastq/FFF/{samples}_R1.fastq.gz")
...
rule bwa_mem:
    input:
        read1 = "fastq/FFF/{samples}_R1.fastq.gz",
        read2 = "fastq/FFF/{samples}_R2.fastq.gz",
    ...
    shell:
        ...
        READGROUP="@RG\\tID:$ANIMAL\\tPU:FFF\\tSM:$ANIMAL\\tPL:ILLUMINA\\tLB:ILLUMINA"
