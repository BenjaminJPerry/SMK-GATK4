...
rule merge_bcftools_vcf:
    ...
    output:
        merged = "results/04_merged/merged.FFF.chrom.norm.DPFilt.QUAL60.bcftools.vcf.gz",
...
rule merge_freebayes_vcf:
    ...
    output:
        merged = "results/04_merged/merged.FFF.chrom.norm.DPFilt.QUAL60.freebayes.vcf.gz",
