...
rule all:
    input:
        "results/02_snvs/merged.FFF.chrom.norm.bcftools.vcf.gz",
        "results/02_snvs/merged.FFF.chrom.norm.freebayes.vcf.gz",
...
rule merge_bcftools_vcf:
    ...
    output:
        merged = "results/02_snvs/merged.FFF.rawsnvs.norm.bcftools.vcf.gz",
        csi = "results/02_snvs/merged.FFF.rawsnvs.norm.bcftools.vcf.gz.csi"
    benchmark:
...
rule view_bcftools_chrom:
    ...
    input:
        ...
        csi = "results/02_snvs/merged.FFF.rawsnvs.norm.bcftools.vcf.gz.csi"
    output:
        filtered_vcf = "results/02_snvs/merged.FFF.chrom.norm.bcftools.vcf.gz",
        filtered_vcf_csi = "results/02_snvs/merged.FFF.chrom.norm.bcftools.vcf.gz.csi"
    params:
...
rule merge_freebayes_vcf:
    ...
    output:
        merged = "results/02_snvs/merged.FFF.rawsnvs.norm.freebayes.vcf.gz",
        csi = "results/02_snvs/merged.FFF.rawsnvs.norm.freebayes.vcf.gz.csi",
    benchmark:
...
rule view_freebayes_chrom:
    ...
    input:
        ...
        csi = "results/02_snvs/merged.FFF.rawsnvs.norm.freebayes.vcf.gz.csi",
    output:
        filtered_vcf = "results/02_snvs/merged.FFF.chrom.norm.freebayes.vcf.gz",
        filtered_vcf_csi = "results/02_snvs/merged.FFF.chrom.norm.freebayes.vcf.gz.csi"
    params:
        chromosomes = "NC_056054.1,NC_056055.1,NC_056056.1,NC_056057.1,NC_056058.1,NC_056059.1,NC_056060.1,NC_056061.1,NC_056062.1,NC_056063.1,NC_056064.1,NC_056065.1,NC_056066.1,NC_056067.1,NC_056068.1,NC_056069.1,NC_056070.1,NC_056071.1,NC_056072.1,NC_056073.1,NC_056074.1,NC_056075.1,NC_056076.1,NC_056077.1,NC_056078.1,NC_056079.1,NC_056080.1"
    benchmark:
