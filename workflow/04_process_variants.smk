...
rule ensemble_intersection:
    ...
    shell:
        ...
        mv results/05_ensemble/0000.vcf.gz {output.bcftools_uniq};
        ...
        mv results/05_ensemble/0001.vcf.gz {output.freebayes_uniq};
        ...
        mv results/05_ensemble/0002.vcf.gz {output.haplotypeCaller_uniq};
