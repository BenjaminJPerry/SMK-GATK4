...
rule all:
    input:
        "results/02_snvs/merged.MFF.chrom.norm.haplotypeCaller.vcf.gz",
        "results/02_snvs/merged.MFF.chrom.norm.haplotypeCaller.vcf.gz.csi"
...
rule merge_animals_vcf:
    priority:100
    input:
        vcfgz = expand("results/02_snvs/{samples}.rawsnvs.norm.haplotypeCaller.vcf.gz", samples = SAMPLES),
        csi = expand("results/02_snvs/{samples}.rawsnvs.norm.haplotypeCaller.vcf.gz.csi", samples = SAMPLES),
    output:
        merged = "results/02_snvs/merged.MFF.rawsnvs.norm.haplotypeCaller.vcf.gz",
        csi = "results/02_snvs/merged.MFF.rawsnvs.norm.haplotypeCaller.vcf.gz.csi",
    benchmark:
...
rule view_haplotype_chrom:
    priority:100
    input:
        merged_vcf = "results/02_snvs/merged.MFF.rawsnvs.norm.haplotypeCaller.vcf.gz",
        csi = "results/02_snvs/merged.MFF.rawsnvs.norm.haplotypeCaller.vcf.gz.csi",
    output:
        filtered_vcf = "results/02_snvs/merged.MFF.chrom.norm.haplotypeCaller.vcf.gz",
        filtered_vcf_csi = "results/02_snvs/merged.MFF.chrom.norm.haplotypeCaller.vcf.gz"
    params:
