...
rule merge_animals_vcf:
    ...
    output:
        merged = "results/02_snvs/merged.MFF.rawsnvs.norm.DPFilt.QUAL60.haplotypeCaller.vcf.gz",
        csi = "results/02_snvs/merged.MFF.rawsnvs.norm.DPFilt.QUAL60.haplotypeCaller.vcf.gz.csi",
    benchmark:
...
rule view_haplotype_chrom:
    priority:100
    input:
        merged_vcf = "results/02_snvs/merged.MFF.rawsnvs.norm.DPFilt.QUAL60.haplotypeCaller.vcf.gz",
        csi = "results/02_snvs/merged.MFF.rawsnvs.norm.DPFilt.QUAL60.haplotypeCaller.vcf.gz.csi",
    output:
        filtered_vcf = "results/02_snvs/merged.MFF.chrom.norm.DPFilt.QUAL60.haplotypeCaller.vcf.gz",
        filtered_vcf_csi = "results/02_snvs/merged.MFF.chrom.norm.DPFilt.QUAL60.haplotypeCaller.vcf.gz.csi"
    params:
